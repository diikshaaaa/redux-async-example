...
class App extends Component {
  static propTypes = {
  // Static propTypes are called directly on the class (here App) - without creating an instance/object of the class.
  ...
  // componentDidMount () is a hook that gets invoked right after a React component has been mounted aka after the first render () 
